...
export default {
    ...
    mutations: {
        ...
        // USER
        SET_USER_TOTAL_RECORD (state, value) {
            state.user.totalRecord = value
        },
        ...
        getDataUser ({ commit, state }, data) {
            ...
            return axios.post('/api/user/getAll', params, { 
                ...
                .then((res) => {
                    ...
                    commit('SET_USER_DATA', dataPrev)
                    commit('SET_USER_TOTAL_RECORD', res.data.total_record)
