...
export default {
    ...
    actions: {
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/position/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/position/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/position/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
        ...
        uploadCover ({ commit, state }, data) {
            ...
            return axios.post('/api/position/uploadImage', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
