...
export default {
    ...
    actions: {
        ...
        getData ({ commit, state }, data) {
            ...
            return axios.post('/api/productToping/getAll', params, { 
                ...
                .then((res) => {
                    ...
                    payload && payload.map((dt) => {
                        dataPrev.push({ ...dt.productToping })
                    })
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/productToping/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/productToping/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/productToping/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
        ...
        uploadCover ({ commit, state }, data) {
            ...
            params.append('product_toping_id', data.product_toping_id)
            params.append('image', data.image)
    
            return axios.post('/api/productToping/uploadImage', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
